...
#define kernelInBatchNum 144
#define kernelInTotalNum 288

#define kernelOutBatchNum 72
#define kernelOutTotalNum 144
...
#define CGRAWTest() \
    CGRAW(kernelInBatchNum ,kernelInTotalNum,(void *)inputData[0],(0b111111100000010) , (0b100000000000000))
