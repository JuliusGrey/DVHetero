package RISCV.BUS.mem2

import chisel3._
import chisel3.util._
import chisel3.util.experimental.BoringUtils
import RISCV.common.Interface.{SignalRAM, cacheIO, cpuRWIO}
import RISCV.common.Param.{CacheSram, SRAMaddrW, SRAMdataW, addrW, dataW, reduceTimeWay}
...
class Dcache() extends Module{
  ...
  val tag = io.cacheIn.addr(addrW - 1, offW + SRAMaddrW)
  //基本状态机
  val cacheIdle :: cacheMiss  ::cacheRead :: cacheWrite :: cacheBlock :: Nil = Enum(4)
  val cacheState = RegInit(cacheIdle)
